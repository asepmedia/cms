...
<script type="text/javascript">
	...
	$( document ).ready( function() {
		...
		$( '#submit' ).on('click', function(event) {
			...
			fill_data.append('post_author_name', $('#post_author_name').val());
			fill_data.append('post_video', $('#post_video').val());
			// send data
			$.ajax({
				url: '<?=$action;?>',
				type: 'POST',
					...
					<div class="box-body">
						...
						<div class="form-group">
							<label class="control-label">Penulis</label>
								<input type="text" name="post_author_name" class="form-control" id="post_author_name" value="<?=$query ? $query->post_author_name : ''?>" placeholder="Admin">
						</div>
						<div class="form-group">
							<label class="control-label">Video Custom</label>
								<input type="text" name="post_video" class="form-control" id="post_video" value="<?=$query ? $query->post_video : ''?>" placeholder="https://www.youtube.com?watch=3a454d">
						</div>												
					</div>
					<div class="box-footer">
