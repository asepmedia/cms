      ...
      <div class="col-lg-4">
         <div class="box box-default">
            ...
            <div class="box-body">
               ...
               <div class="form-group">
                  <label class="control-label" for="post_comment_status">Password</label>
                  <input type="text" name="post_password" id="post_password" class="form-control input-sm" value="<?=($query ? $query->post_password : 'no');?>">
               </div>
            </div>
