 ...
 * Get Counters
 */
if (! function_exists('get_counters_all')) {
	function get_counters_all() {
		$CI = &get_instance();
		$CI->load->model('m_posts');
		return $CI->m_posts->get_counters_all();
	}
}
if (! function_exists('get_counters')) {
	function get_counters() {
		$CI = &get_instance();
		$CI->load->model('m_posts');
		return $CI->m_posts->get_counters();
	}
}
if (! function_exists('get_counters_yes')) {
	function get_counters_yes() {
		$CI = &get_instance();
		$CI->load->model('m_posts');
		return $CI->m_posts->get_counters_yes();
	}
}
if (! function_exists('get_tracker')) {
	function get_tracker() {
		$CI = &get_instance();
		$CI->load->model('m_posts');
		return $CI->m_posts->get_tracker();
	}
}
if (! function_exists('get_counters_week')) {
	function get_counters_week() {
		$CI = &get_instance();
		$CI->load->model('m_posts');
		return $CI->m_posts->get_counters_week();
	}
}
if (! function_exists('get_counters_month')) {
	function get_counters_month() {
		$CI = &get_instance();
		$CI->load->model('m_posts');
		return $CI->m_posts->get_counters_month();
	}
}
/**
 * Get Archive
...
if (! function_exists('get_popular_posts')) {
     ...
     * Get Popular Posts
     */
if (! function_exists('get_order_lists')) {       
    function get_order_lists($where) {
        $CI = &get_instance();
        $CI->load->model('m_orders');
        return $CI->m_orders->get_order_lists($where);
    }
}
    /**
     * Get Popular Posts
     */
if (! function_exists('get_order_lists_all')) {       
    function get_order_lists_all() {
        $CI = &get_instance();
        $CI->load->model('m_orders');
        return $CI->m_orders->get_order_lists_all();
    }
}
/**
...
if (! function_exists('get_related_products')) {
	function get_related_products($get_post_categories, $id) {
		$CI = &get_instance();
		$CI->load->model('m_katalog');
		return $CI->m_katalog->get_related_posts($get_post_categories, $id);
	}
}
/**
 * Get Welcome
