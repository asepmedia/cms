...
class Superuser extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model(['m_superuser', 'm_user_groups']);
		$this->pk = M_superuser::$pk;
		$this->table = M_superuser::$table;
	}
	...
	public function index() {
		...
		$this->vars['acl'] = $this->vars['superuser'] = true;
		$this->vars['user_groups_dropdown'] = json_encode($this->m_user_groups->dropdown());
		$this->vars['content'] = 'users/superuser';
	...
	public function pagination() {
		...
		$query = $this->m_superuser->get_where($keyword, $limit, $offset, 'super_user', $sort_field, $sort_type);
		$total_rows = $this->m_superuser->total_rows($keyword);
