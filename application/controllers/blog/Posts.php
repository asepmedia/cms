...
class Posts extends Admin_Controller {
	...
	public function create() {
		...
		$this->vars['title'] = $id && is_int(intval($id)) ? 'Edit Posting' : 'Tambah Posting';
	...
	private function fill_data() {
		return [
			...
			'post_author_name' => $this->input->post('post_author_name', true),
			'post_video' => $this->input->post('post_video', true)			
		];
	}
