...
class Semenbeku extends CI_Controller{
	...
	public function __construct() {
		parent::__construct();
		$this->load->model(['m_semen', 'm_post_categories']);
		$this->pk = M_Semen::$pk;
		$this->table = M_Semen::$table;
	...
	public function index() {
		...
		$this->vars['blog'] = $this->vars['semenbeku'] = $this->vars['all_semenbeku'] = true;
		$this->vars['content'] = 'semenbeku/read';
	...
	public function pagination() {
		...
		$query = $this->m_semen->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
		$total_rows = $this->m_semen->total_rows($keyword);
