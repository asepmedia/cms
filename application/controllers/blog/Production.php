...
class Production extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model(['m_production', 'm_post_categories']);
		$this->pk = M_production::$pk;
		$this->table = M_production::$table;
	}
	...
	public function index() {
		...
		$this->vars['blog'] = $this->vars['production'] = $this->vars['all_production'] = true;
		$this->vars['content'] = 'production/read';
	...
	public function pagination() {
		...
		$query = $this->m_production->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
		$total_rows = $this->m_production->total_rows($keyword);
