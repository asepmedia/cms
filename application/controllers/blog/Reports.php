...
class Reports extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model(['m_reports', 'm_post_categories']);
		$this->pk = M_reports::$pk;
		$this->table = M_reports::$table;
	}
	...
	public function index() {
		...
		$this->vars['blog'] = $this->vars['reports'] = $this->vars['all_reports'] = true;
		$this->vars['content'] = 'reports/read';
	...
	public function create() {
		...
		$this->vars['title'] = $id && is_int(intval($id)) ? 'Edit Laporan' : 'Tambah Laporan';
		$this->vars['blog'] = $this->vars['reports'] = $this->vars['reports_create'] = true;
		$this->vars['action'] = site_url('blog/reports/save/'.$id);
		$this->vars['content'] = 'reports/create';
		$this->load->view('backend/index', $this->vars);
	}
	...
	public function pagination() {
		...
		$query = $this->m_reports->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
		$total_rows = $this->m_reports->total_rows($keyword);
