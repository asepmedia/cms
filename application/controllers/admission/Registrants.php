...
class Registrants extends Admin_Controller {
	...
	public function index() {
		...
		if (get_school_level() == 4 || get_school_level() == 5) {
	...
	public function pagination() {
		...
		$query = $this->m_registrants->get_where($keyword, $limit, $offset, $sort_field, $sort_type);
	...
	private function fill_data() {
		return [
			...
			'kps_receiver' => $this->input->post('kps_receiver', true),
			'kps_number' => $this->input->post('kps_number', true),
