...
$route['read/reports/(:num)/(:any)'] = 'public/readmore/report';
$route['read/katalog/(:num)/(:any)'] = 'public/readmore/katalog';
...
$route['categoryreport/(:any)'] = 'public/post_categories/report';
$route['product/(:any)'] = 'public/post_categories/katalog';
$route['archives/([0-9]{4})/([0-9]{2})'] = 'public/archives';
$route['tag/(:any)'] = 'public/post_tags';
$route['tag/reports/(:any)'] = 'public/post_tags/reports';
$route['product/category/(:any)'] = 'public/post_tags/katalog';
$route['sitemap'] = 'public/sitemap';
$route['stok-semen-beku'] = 'public/stock_sb';
...
$route['signup'] = 'public/login/signup';
$route['signup/process']['post'] = 'public/login/signup';
...
$route['default_controller'] = 'home/landing_page';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
